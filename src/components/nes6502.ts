...
export class Nes6502 extends EventHandler {
  constructor(bus: Bus, logger?: Logger) {
    ...
    this.opCodeLookup = [
      // 00
      {
        name: 'BRK',
        operation: this.BRK,
        addressingMode: this.addressingModes.IMP,
      }, // 00
      {
        name: 'ORA',
        operation: this.ORA,
        addressingMode: this.addressingModes.IZX,
      }, // 01
      {
        name: 'STP',
        operation: this.STP,
      ...
      }, // 02
      {
        name: 'SLO',
        operation: this.SLO,
        addressingMode: this.addressingModes.IZXRW,
      }, // 03

      {
        name: 'NOP',
        operation: this.NOP,
        addressingMode: this.addressingModes.ZP0,
      }, // 04
      {
        name: 'ORA',
        operation: this.ORA,
      ...
      }, // 05
      {
        name: 'ASL',
        operation: this.ASL,
        addressingMode: this.addressingModes.ZP0RW,
      }, // 06
      {
        name: 'SLO',
        operation: this.SLO,
      ...
      }, // 08
      {
        name: 'ORA',
        operation: this.ORA,
        addressingMode: this.addressingModes.IMM,
      }, // 09
      {
        name: 'ASL',
        operation: this.ASL,
...

      {
        name: 'NOP',
        operation: this.NOP,
        addressingMode: this.addressingModes.ABS,
      }, // 0C
      {
        name: 'ORA',
        operation: this.ORA,
      ...
      }, // 0D
      {
        name: 'ASL',
        operation: this.ASL,
        addressingMode: this.addressingModes.ABSRW,
      }, // 0E
      {
        name: 'SLO',
        operation: this.SLO,
      ...
      // 10
      {
        name: 'BPL',
        operation: this.BPL,
        addressingMode: this.addressingModes.REL,
      }, // 10
      {
        name: 'ORA',
        operation: this.ORA,
        addressingMode: this.addressingModes.IZY,
      }, // 11
      {
        name: 'STP',
        operation: this.STP,
      ...
      }, // 12
      {
        name: 'SLO',
        operation: this.SLO,
        addressingMode: this.addressingModes.IZYRW,
      }, // 13

      {
        name: 'NOP',
        operation: this.NOP,
        addressingMode: this.addressingModes.ZPX,
      }, // 14
      {
        name: 'ORA',
        operation: this.ORA,
      ...
      }, // 15
      {
        name: 'ASL',
        operation: this.ASL,
        addressingMode: this.addressingModes.ZPXRW,
      }, // 16
      {
        name: 'SLO',
        operation: this.SLO,
      ...
      }, // 18
      {
        name: 'ORA',
        operation: this.ORA,
        addressingMode: this.addressingModes.ABYR,
      }, // 19
      {
        name: 'NOP',
        operation: this.NOP,
      ...
      }, // 1A
      {
        name: 'SLO',
        operation: this.SLO,
        addressingMode: this.addressingModes.ABYRW,
      }, // 1B

      {
        name: 'NOP',
        operation: this.NOP,
        addressingMode: this.addressingModes.ABXR,
      }, // 1C
      {
        name: 'ORA',
        operation: this.ORA,
      ...
      // 20
      {
        name: 'JSR',
        operation: this.JSR,
        addressingMode: this.addressingModes.NUL,
      }, // 20. JSR will do its own adressing.
      {
        name: 'AND',
        operation: this.AND,
        addressingMode: this.addressingModes.IZX,
...

      {
        name: 'JMP',
        operation: this.JMP,
        addressingMode: this.addressingModes.IND,
      }, // 6C
      {
        name: 'ADC',
        operation: this.ADC,
      ...
      }, // 95
      {
        name: 'STX',
        operation: this.STX,
        addressingMode: this.addressingModes.ZPY,
      }, // 96
      {
        name: 'SAX',
        operation: this.SAX,
      ...
      }, // 98
      {
        name: 'STA',
        operation: this.STA,
        addressingMode: this.addressingModes.ABYW,
      }, // 99
      {
        name: 'TXS',
        operation: this.TXS,
...

      {
        name: 'SHY',
        operation: this.SHY,
        addressingMode: this.addressingModes.ABXW,
      }, // 9C
      {
        name: 'STA',
        operation: this.STA,
  ...
  JSR() {
    ...
    */
    ...
    this.microCodeStack.push(() => {
      ...
      temp = this._t;
      this.pc++;
      this.read(0x100 | this.stackPointer);
    });
    this.microCodeStack.push(() => {
      this.pushStack(this.pc >> 8);
    });
  ...
  AHX() {
    this.microCodeStack.push(() => {
      this.bus.write(undefined, this.a & this.x & (this.bus.addr >> 8));
    });
    this.NOP();
  }
  SHY() {
    this.microCodeStack.push(() => {
      this.bus.write(undefined, this.y & (this.bus.addr >> 8));
    });
    this.NOP();
  }
  SHX() {
    this.microCodeStack.push(() => {
      this.bus.write(undefined, this.x & (this.bus.addr >> 8));
    });
    this.NOP();
  }
  TAS() {
    this.microCodeStack.push(() => {
      ...
      this.bus.write(undefined, this.stackPointer & (this.bus.addr >> 8));
    });
    this.NOP();
  }
  LAS() {
  ...
  STP() {
    // KIL processor should get stuck in an infinite loop trying to process this code.
    this.microCodeStack.push(() => {
      this.STP();
    });
  }
  ...
  public clock(): void {
    ...
    if (this.microCodeStack.length) {
      ...
      this.fetch = this.opCodeLookup[this._t];
      this.count++;
  ...
  public read(addr: number | undefined): void {
    this._t = this.bus.read(addr);
  }
}
